...
async def import_rows(
    ...
    for r in rows:
        ...
        row = HistoryPriceSnapshot(
            ...
            material_name=(r["package_name"] or "")[:500],
            category=(r["category"] or "")[:500] or None,
            package_name=(r["package_name"] or "")[:500] or None,
            publisher=(r["publisher"] or "")[:500] or None,
            price_mode=(r["price_mode"] or "")[:30],
            limit_price=r["limit_price"],
            win_price=r["win_price"],
            win_date=r["win_date"],
            publish_date=r["publish_date"],
            notice_id=(r["notice_id"] or "")[:300] or None,
            limit_evidence=(r["limit_evidence"] or "")[:500] or None,
            win_evidence=(r["win_evidence"] or "")[:500] or None,
            limit_evidence_url=(r["limit_evidence_url"] or "")[:500] or None,
            win_evidence_url=(r["win_evidence_url"] or "")[:500] or None,
            source_hash=h,
        )
        session.add(row)
        imported += 1
