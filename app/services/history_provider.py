...
async def snapshot_samples(
    ...
    for s in samples:
        ...
        row = HistoryPriceSnapshot(
            ...
            material_name=(str(s.get("material_name") or ""))[:500],
            material_code=(str(s.get("material_code") or ""))[:200] or None,
            spec=(str(s.get("spec") or ""))[:500] or None,
            region=(str(s.get("region") or ""))[:300] or None,
